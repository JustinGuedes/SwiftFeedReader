...
public extension RSS {
    ...
    struct Channel {
        ...
        fileprivate static let makeRSSChannel = curry(Channel.init)
        
    }
    
}

extension RSS.Channel: Equatable {
    
    public static func ==(lhs: RSS.Channel, rhs: RSS.Channel) -> Bool {
...
extension RSS.Channel {
    
    static var parameter: Parameter<RSS.Channel> {
